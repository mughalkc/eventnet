...
const VendorRevenue = () => {
  ...
  const fetchRevenue = async () => {
    try {
      ...
      const revenueResponse = await fetch('https://eventnet-6c6d.vercel.app/api/vendor/revenue', {
        method: 'GET',
        headers: {
      ...
      const eventsResponse = await fetch('https://eventnet-6c6d.vercel.app/api/vendor/events', {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`
        }
      })
