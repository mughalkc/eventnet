...
export default function EventDetails() {
  ...
  const fetchEventDetails = async () => {
    try {
      const response = await fetch(`https://eventnet-6c6d.vercel.app/api/admin/events/${eventId}`, {
        headers: {
  ...
  const fetchRegistrations = async () => {
    try {
      const response = await fetch(`https://eventnet-6c6d.vercel.app/api/admin/events/${eventId}/registrations`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('adminToken')}`,
          'Content-Type': 'application/json'
        }
  ...
  const fetchInsights = async () => {
    try {
      const response = await fetch(`https://eventnet-6c6d.vercel.app/api/admin/events/${eventId}/insights`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('adminToken')}`,
          'Content-Type': 'application/json'
        }
  ...
  const handleStatusChange = async (newStatus) => {
    try {
      const response = await fetch(`https://eventnet-6c6d.vercel.app/api/admin/events/${eventId}/status`, {
        method: 'PATCH',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('adminToken')}`,
          'Content-Type': 'application/json'
